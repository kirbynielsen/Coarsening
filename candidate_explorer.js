...
(function() {
  ...
  function ensureLightStyles() {
    ...
    extra.forEach(v => {
      ...
      css += '.mini-chip.' + k + '.state-on{background:#fff;border-left:4px solid ' + stroke + ';}';
      ...
      css += '.bulb-cell.' + k + '.off{background:' + dot + ';border-color:' + glow + ';}';
      css += '.mini-bulb.' + k + '.off{background:' + dot + ';border-color:' + glow + ';}';
      css += '.mini-chip.' + k + '.state-off{background:#fff;border-left:4px solid ' + glow + ';}';
    });
