...
(function() {
  ...
  function ensureLightStyles() {
    ...
    extra.forEach(v => {
      ...
      css += '.mini-chip.' + k + '.state-on{background:#fff;border-color:' + stroke + ';}';
      ...
      css += '.mini-chip.' + k + '.state-off{background:#fff;border-color:' + glow + ';}';
    });
