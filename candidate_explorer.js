...
(function() {
  ...
  function ensureLightStyles() {
    ...
    extra.forEach(v => {
      ...
      const glow = 'hsl(' + hue + ' 62% 80%)', pale = 'hsl(' + hue + ' 62% 97%)';
      css += '.bulb-cell.' + k + '.off{background:' + glow + ';border-color:' + fill + ';}';
      css += '.mini-bulb.' + k + '.off{background:' + glow + ';border-color:' + fill + ';}';
