...
(function () {
  ...
  (function ensureLightStyles() {
    var extra = VARS.filter(function (v) { return v.kind === 'attribute' && v.pos > 4; });
    ...
    extra.forEach(function (v) {
      ...
      var glow = 'hsl(' + hue + ' 62% 80%)', pale = 'hsl(' + hue + ' 62% 97%)', dot = 'hsl(' + hue + ' 62% 94%)';
