...
(function () {
  ...
  function readConfig() {
    ...
    try { if (window.Qualtrics && Qualtrics.SurveyEngine && typeof Qualtrics.SurveyEngine.getEmbeddedData === 'function') { const raw = Qualtrics.SurveyEngine.getEmbeddedData('pm_choice'); if (raw) mergeInto(cfg, JSON.parse(raw)); } } catch (_) {}
  ...
  function loadPart1() { try { return JSON.parse(localStorage.getItem('candidateExplorer.part1')); } catch (_) { return null; } }
